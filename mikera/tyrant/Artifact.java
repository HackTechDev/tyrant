 ...
 * 
 * Artifacts should be immutable and unchangeable, e.g.
 * - Immune to damage
 * - Unaffected by runes
 * - Impossible to change status i.e. cursed/blessed
 * 
 * 
...
public class Artifact {
	...
	public static void initCrowns() {
		...
		t.add("WieldedModifiers",Modifier.addHandler("OnAction",Monster.breathAttack("fire","blazing flames",4,50,1)));
		t.set("Armour",6);
		t.set("Image",428);
		t.set("LevelMin",35);
		t.set("IsRandomArtifact",1);
