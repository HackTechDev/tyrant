...
public class Ring  {
    ...
    public static void initRings() {
        ...
        t.add("WieldedModifiers",Modifier.bonus("MoveSpeed",RPG.d(40)));
        t.set("LevelMin",5);
        addRing(t);
        
        t = Lib.extend("ring of strength", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus("ST",RPG.d(4)));
        t.set("LevelMin",1);
        addRing(t);
        
        t = Lib.extend("ring of skill", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus("SK",RPG.d(4)));
        t.set("LevelMin",1);
        addRing(t);
        
        t = Lib.extend("ring of agility", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus("AG",RPG.d(2,4)));
        t.set("LevelMin",10);
        addRing(t);
        
        t = Lib.extend("ring of toughness", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus("TG",RPG.d(2,4)));
        t.set("LevelMin",15);
        addRing(t);
        
        t = Lib.extend("ring of intelligence", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus("IN",RPG.d(4)));
        t.set("LevelMin",5);
        addRing(t);
        
        t = Lib.extend("ring of willpower", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus("WP",RPG.d(2,4)));
        t.set("LevelMin",15);
        addRing(t);
        
        t = Lib.extend("ring of charisma", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus("CH",RPG.d(2,4)));
        t.set("LevelMin",1);
        addRing(t);
        
        t = Lib.extend("ring of craft", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus("CR",RPG.d(2,4)));
        t.set("LevelMin",5);
        addRing(t);
        
        t = Lib.extend("ring of protection", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus("ARM",RPG.d(3,4)));
        t.set("LevelMin",3);
        addRing(t);
        
        t = Lib.extend("ring of reading", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus(Skill.LITERACY,RPG.d(3)));
        t.set("LevelMin",8);
        addRing(t);
        
        t = Lib.extend("ring of the great trader", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus(Skill.TRADING,RPG.d(2,3)));
        t.set("LevelMin",10);
        addRing(t);
 
        t = Lib.extend("ring of thieves", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus(Skill.DODGE,RPG.r(2)));
        t.add("WieldedModifiers",Modifier.bonus(Skill.STEALTH,RPG.r(2)));
        t.add("WieldedModifiers",Modifier.bonus(Skill.PICKLOCK,RPG.r(2)));
        t.add("WieldedModifiers",Modifier.bonus(Skill.PICKPOCKET,RPG.r(2)));
        t.set("LevelMin",15);
        addRing(t);
		
        t = Lib.extend("ring of the warrior", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus(Skill.ATTACK,RPG.r(3)));
        t.add("WieldedModifiers",Modifier.bonus(Skill.DEFENCE,RPG.r(3)));
        t.add("WieldedModifiers",Modifier.bonus(Skill.ARCHERY,RPG.r(3)));
        t.add("WieldedModifiers",Modifier.bonus(Skill.THROWING,RPG.r(3)));
        t.set("LevelMin",25);
        addRing(t);
       
        t = Lib.extend("ring of armour reduction", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus("ARM",-1));
        t.set("IsCursed",1);
        t.set("LevelMin",5);
        addRing(t);
        
        t = Lib.extend("ring of short sight", "plain ring");
        t.add("WieldedModifiers",Modifier.linear("VisionRange",60,0));
        t.set("IsCursed",1);
        t.set("LevelMin",1);
        addRing(t);
		
        t = Lib.extend("ring of long sight", "plain ring");
        t.add("WieldedModifiers",Modifier.linear("VisionRange",100,2));
        t.set("LevelMin",3);
        addRing(t);
		
        t = Lib.extend("ring of far sight", "plain ring");
        t.add("WieldedModifiers",Modifier.linear("VisionRange",150,2));
        t.set("LevelMin",23);
        addRing(t);
        
        t = Lib.extend("ring of fire resistance", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus("RES:fire",RPG.d(2,6)));
        t.set("LevelMin",5);
        addRing(t);
        
        t = Lib.extend("ring of ice resistance", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus("RES:ice",RPG.d(2,6)));
        t.set("LevelMin",5);
        addRing(t);
        
        t = Lib.extend("ring of poison resistance", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus("RES:poison",RPG.d(2,6)));
        t.set("LevelMin",5);
        addRing(t);
        
        t = Lib.extend("ring of antivenom", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus("RES:poison",RPG.d(2,8)));
        t.set("LevelMin",5);
        addRing(t);
        
        t = Lib.extend("ring of ferocity", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus("AttackSpeed",RPG.d(40)));
        t.add("WieldedModifiers",Modifier.bonus(Skill.ATTACK,1));
        t.set("LevelMin",13);
        addRing(t);
        
        t = Lib.extend("ring of survival", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus(Skill.SURVIVAL,RPG.d(3)));
        t.set("LevelMin",4);
        addRing(t);
        
        t = Lib.extend("ring of throwing", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus(Skill.THROWING,RPG.d(3)));
        t.set("LevelMin",7);
        addRing(t);
        
        t = Lib.extend("ring of stealth", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus(Skill.STEALTH,RPG.d(2)));
        t.set("LevelMin",22);
        addRing(t);
        
        t = Lib.extend("wedding ring", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus("CH",RPG.r(3)));
        t.set("LevelMin",9);
        addRing(t);
        
        t = Lib.extend("ring of ugliness", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus("CH",-RPG.d(2,6)));
        t.set("IsCursed",1);
        t.set("LevelMin",2);
        addRing(t);
        
        t = Lib.extend("ring of hunger", "plain ring");
        t.add("WieldedModifiers",Modifier.linear(RPG.ST_HUNGERTHRESHOLD,50,0));
        t.set("IsCursed",1);
        t.set("LevelMin",6);
        addRing(t);
        
        t = Lib.extend("ring of starvation", "plain ring");
        t.add("WieldedModifiers",Modifier.linear(RPG.ST_HUNGERTHRESHOLD,25,0));
        t.set("IsCursed",1);
        t.set("LevelMin",15);
        addRing(t);
        
        t = Lib.extend("ring of slow digestion", "plain ring");
        t.add("WieldedModifiers",Modifier.linear(RPG.ST_HUNGERTHRESHOLD,150,0));
        t.set("LevelMin",14);
        addRing(t);
        
        t = Lib.extend("ring of divine sustenance", "plain ring");
        t.add("WieldedModifiers",Modifier.linear(RPG.ST_HUNGERTHRESHOLD,300,0));
        t.set("LevelMin",22);
        addRing(t);
        
        t = Lib.extend("ring of slowness", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus("MoveSpeed",-RPG.d(2,20)));
        t.add("WieldedModifiers",Modifier.bonus(RPG.ST_AG,-RPG.d(4)));
        t.set("IsCursed",1);
        t.set("LevelMin",5);
        addRing(t);
        
        t = Lib.extend("ring of weakness", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus(RPG.ST_ST,-RPG.d(4)));
        t.add("WieldedModifiers",Modifier.bonus(RPG.ST_TG,-RPG.d(4)));
        t.set("IsCursed",1);
        t.set("LevelMin",9);
        addRing(t);
        
        t = Lib.extend("ring of weak will", "plain ring");
        t.add("WieldedModifiers",Modifier.linear(RPG.ST_WP,50,0));
        t.set("IsCursed",1);
        t.set("LevelMin",12);
        addRing(t);
        ...
        t.add("WieldedModifiers",Modifier.bonus("Luck",50));
        t.set("LevelMin",26);
        addRing(t);
        ...
        t.add("WieldedModifiers",blm);
        t.set("LevelMin",6);
        addRing(t);
        
        t = Lib.extend("ring of blindness", "plain ring");
        t.add("WieldedModifiers",Modifier.linear("IsBlind",0,1));
        t.set("IsCursed",1);
        t.set("LevelMin",25);
        addRing(t);
    }
