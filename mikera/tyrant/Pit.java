...
public class Pit {
	...
	public static Map create(int level) {
		int size=9+RPG.d(level);
		Map m=new Map(size,size);
		m.set("Level",level);
		build(m,0,level);
	...
	public static Map createArtifactVault(String monsterType, int level) {
		Map m=new Map(21,21);
	...
	public static void build(Map m,int t, int level) {
		int w=m.width;
		int h=m.height;
	...
	public static void buildPitComplex(Map m, int x1, int y1, int x2, int y2) {
