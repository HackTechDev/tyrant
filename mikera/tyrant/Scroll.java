        ...
        public static void initSpecialScrolls() {
            ...
            t.set("OnRead",new Script() {
                ...
                public boolean handle(Thing t, Event e) {
            		...
            		if (detected) Game.message("You shudder with an uneasy chill");
            		else Game.message("You feel a strong sense of relief");
            		return true;
            	}
            });
            t.set("LevelMin",1);
            ...
            t.set("OnRead",new Script() {
                ...
                public boolean handle(Thing t, Event e) {
            		...
            		if (cursed) Game.message("You shudder with an uneasy chill");
            		else Game.message("You feel a strong sense of relief");
            		return true;
            	}
            });
