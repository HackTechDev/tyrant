...
public class Potion  {
    ...
    public static void initRandomPotions() {
        ...
        t.set("LevelMin",8);
        // create bonus effect
        {	Thing effect=Effect.temporary(Modifier.bonus("ST",RPG.d(6)),2000);
        ...
        t.set("LevelMin",6);
        // create bonus effect
        {	Thing effect=Effect.temporary(Modifier.bonus("IN",RPG.d(6)),2000);
        ...
        // create bonus effect
        {	
        	Thing effect=Effect.temporary(Modifier.bonus("IN",RPG.d(8)),2000);
        ...
        t.addHandler("OnDip",new Script() {
            ...
            public boolean handle(Thing t, Event e) {
        		...
        		if (t.getFlag("IsCursed")) {
        			...
        			tt.damage(tt.getStat("HPSMAX")/2,RPG.DT_SPECIAL);
        		} else {
        			if (Item.repair(tt,false)) {
        				Game.message(tt.getYourName()+" is surrounded by a shining orange light");	
        			} else {
        				Game.message(tt.getYourName()+" glows orange for a second");	
        			}
        		}
        		return false;
        	}
        ...
        t.addHandler("OnDip",new Script() {
            ...
            public boolean handle(Thing t, Event e) {
        		...
        		if (t.getFlag("IsCursed")) {
        			...
        			tt.damage(tt.getStat("HPSMAX"),RPG.DT_SPECIAL);
        		} else {        		
        			if (Item.repair(tt,true)) {
        				Game.message(tt.getYourName()+" is surrounded by a shining orange light");	
        			} else {
        				Game.message(tt.getYourName()+" glows yellow for a second");	
        			}
        		}
        		return false;
        	}
