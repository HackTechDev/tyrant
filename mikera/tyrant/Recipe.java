    ...
    private static class ReadRecipeScrollScript extends Script {
        ...
        public boolean handle(Thing s, Event e) {
            ...
            if (user.getStat(order)<=0) {
            	Game.message("You identify "+s.getTheName());
            	Game.message("You must acquire the "+order+" skill in order to learn this recipe");
            	return true;
            }
            ...
            Game.message("You now know how to make "+res.getAName());
