...
public class Monster {
        ...
        public boolean handle(Thing thing, Event e) {
    		...
    		if (type.equals("steal")) {
                ...
                if (stealSomething(target,thing,"IsMoney")) {
                    String message=thing.getTheName() + " vanishes in a puff of smoke!";
                ...
                if (stealSomething(target,thing,"IsMagicItem",3)) {
                    String message=thing.getTheName() + " vanishes in a cloud of perfume!";
                    if(teleportAway(thing)) {
    ...
    static void initBase() {
        ...
        t=Lib.extendCopy("base monster", "base being");
        t.set("Frequency",50);
        t.set("IsMonster",1);
        t.set("IsHostile",1);
        t.set("IsLiving",1);
    ...
    static void initBandits() {
        ...
        t.set("Image",84);
        t.set(Skill.UNARMED,1);
        t.set("DefaultThings","5% [IsFood],5%[IsWeapon],5% 1 gold coin, 50% [IsCoin], 40% 20 copper coin");
        t.set("ASCII","h");
        Lib.add(t);
        ...
        t.set("DefaultThings","[IsBow],10 [IsArrow],5% 1 gold coin, 50% 3 silver coin, 40% 20 copper coin");
        Lib.add(t);
        ...
        t.set(Skill.DEFENCE,2);
        t.set(Skill.ATTACK,1);
        t.set("DefaultThings","50%[IsWeapon],10%[IsArmour],5%[IsItem],10 gold coin");
        Lib.add(t);
        ...
        t.set("DefaultThings","100%[IsWeapon],100%[IsArmour],5%[IsItem],10 sovereign");
        Lib.add(t);
    ...
    static void initBigNasties() {
        ...
        t.addHandler("OnAction",breathAttack("poison","poisonous fumes",2,60,41));
    ...
    static void initUndead() {
        Thing t=Lib.extend("base undead", "base monster");
        t.set("IsUndead",1);
        t.set("IsLiving",0);
        t.set("Image",302);
    ...
    static void initDemons() {
    	...
    	t.set("Image",544);
    	t.set("LevelMin",33);
        t.addHandler("OnAction",breathAttack("fire","blazing flames",3,40,1));
    	Lib.add(t);
    	...
    	t.set("LevelMin",34);
    	t.set("UnarmedWeapon",Lib.create("ice attack"));
        t.addHandler("OnAction",breathAttack("ice","a blast of ice",3,40,101));
    	Lib.add(t);
    ...
    static void initGhosts() {
        ...
        t.set("Image",310);
        t.set("LevelMin",17);
        t.set("OnTouch",Scripts.damage("chill",3,"chilled by the touch of the ghost",50));
        Lib.add(t);
        ...
        t.set("OnTouch",Scripts.damage("chill",10,"chilled by the touch of the spectre",50));
        Lib.add(t);    
    ...
    static void initDragons() {
        ...
        t.set("LevelMin",29);
        t.set("Image",645);
        t.addHandler("OnAction",breathAttack("poison","noxious fumes",2,40,41));
        Lib.add(t);
        ...
        t.set("Image",647);
        t.addHandler("OnAction",breathAttack("poison","poisonous fumes",2,60,41));
        t.addHandler("OnAction",breathAttack("fire","blazing flames",2,60,1));
        Lib.add(t);
        ...
        t.set("LevelMin",31);
        t.set("Image",644);
        t.addHandler("OnAction",breathAttack("ice","crackling lightning",3,60,61));
        Lib.add(t);
        ...
        t.set("RES:fire",-15);
        t.set("LevelMin",32);
        t.addHandler("OnAction",breathAttack("ice","a blast of ice",5,60,101));
        ...
        t.set("LevelMin",34);
        t.set("Image",641);
        t.addHandler("OnAction",breathAttack("fire","hellish flames",6,100,1));
        Lib.add(t);
        ...
        t.set(Skill.FOCUS,5);
        t.addHandler("OnAction",breathAttack("fire","hellish flames",4,60,1));
    ...
    static void initSlimes() {
        ...
        t.set("Image",381);
        {
        	ItemDamageHit idh=new ItemDamageHit("wielded","acid",50,10);
	        t.set("OnHit",idh);
        }
        Lib.add(t);
        ...
        t.set("LevelMin",8);
        t.set("Image",380);
        t.set("OnTouch",Scripts.damage("acid",2,"hit by the noxious acid of the purple slime",25));
        Lib.add(t);
        ...
        t.set("Image",382);
        {
        	ItemDamageHit idh=new ItemDamageHit("wielded","fire",40,5);
	        t.set("OnHit",idh);
        }
        t.set("UnarmedWeapon",Lib.create("curse attack"));
