        ...
        public boolean handle(Thing t, Event e) {
            ...
            switch (t.getStat("ChatCount")) {
                case 1:
                    sayName(t);
                    tryToSayHello(h);
                    Game.message("He talks enthusiastically about his latest victory against a marauding " +
                ...
                default:
                    Game.message(t.getTheName() + " chats with you for some time.");
                    t.set("ChatCount", 100);
                    break;
            }
            return false;
        ...
        public boolean handle(Thing t, Event e) {
            ...
            switch (t.getStat("ChatCount")) {
                ...
                case 3:
                    ...
                    if (!RPG.test(h.getStat("CH"),3)) {
                        Game.message(t.getTheName()+ " yawns.");
                        t.set("ChatCount",100);
                    }
                    break;
                case 4:
