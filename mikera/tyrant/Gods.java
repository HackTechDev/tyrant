...
//			Game.hero.set("Gods",h);
	...
	public static void sacrifice(Thing hero, Thing sac) {
		...
		Game.message(sac.getTheName()+" "+sac.is()+" "+god.getString("SacrificeDescription"));
		...
		if (sac.getFlag("IsArtifact")) {
			...
			Game.message("You feel that "+god.name()+" is unimpressed by your pathetic offering");
