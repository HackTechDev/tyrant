...
public class ThingMaker {
    ...
    public void storeThings(Map map, StringBuffer buffer) {
    ...
    public void addThingsToMap(Map map, String mapText) {
    ...
    private void createThings(Map map, String thingsText) {
