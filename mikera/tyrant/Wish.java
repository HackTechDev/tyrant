...
public class Wish {
	...
	public static boolean doPray(int level) {
	...
	public static boolean makeWish(String s,int level) {
		...
		if (c.getFlag("IsArtifact")&&(level<100)) {
			Game.message("You hear a booming voice:");
			Game.message("\"Ha Ha. Very funny!\"");
			return false;
		}
		
		if ((!c.name().equals("strange rock"))&&(c.getStat("Frequency")<=0)&&(level<100)) {
			Game.message("You hear a booming voice:");
